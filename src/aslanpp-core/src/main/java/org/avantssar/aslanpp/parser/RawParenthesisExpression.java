...
public class RawParenthesisExpression extends AbstractRawExpression {

	private final IRawExpression base;

	public RawParenthesisExpression(IScope scope, LocationInfo location, ErrorGatherer err, IRawExpression base) {
	...
	public ITerm getTerm(boolean allowTransmission, boolean strictVarCheck) {
		return base.getTerm(allowTransmission, strictVarCheck);
	}
