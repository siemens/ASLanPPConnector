...
public class Constraint extends GenericScope {

	private IExpression formula;
	private final LocationInfo location;

	public Constraint(LocationInfo location, IScope owner, String name) {
		super(owner, name);
	...
	public void setFormula(IExpression formula) {
