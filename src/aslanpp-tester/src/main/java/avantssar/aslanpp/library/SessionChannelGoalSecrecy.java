...
@Specification
public class SessionChannelGoalSecrecy extends ChannelGoalSecrecy {
	...
	//	IntroduceStatement rcv = bobBody.add(entBob.comm(vBobAlice.term(), entBob.getActorSymbol().term(), vBobM.matchedTerm().annotate(getPPprotName()), null, channelType, true, false, false));
		...
		env.sessionChannelGoal(getPPprotName(), alice.term(), bob.term(), ChannelEntry.confidential.arrow);
	}
