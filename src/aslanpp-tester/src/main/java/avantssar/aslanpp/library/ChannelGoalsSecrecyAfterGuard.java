...
@Specification
public class ChannelGoalsSecrecyAfterGuard extends ChannelGoalSecrecy {
	...
	protected void finishPPmodel() {
		...
		ChannelGoal cg = entBob.chGoal(getPPprotName(), vBobAlice.term(), entBob.getActorSymbol().term(), vBobM.term(), ChannelEntry.confidential);
