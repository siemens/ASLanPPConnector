...
public class VariableTerm extends AbstractTerm<Variable> {

	protected VariableTerm(LocationInfo location, ErrorGatherer err, Variable var) {
		super(location, err, var);
	}
